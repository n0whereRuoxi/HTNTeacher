    ...
    for has_prec in prec:
        for is_curriculum in curriculum:
            for is_prune in prune:
                with open("{}_{}{}{}.txt".format(domain, 'curriculum' if is_curriculum else 'original', '_prune' if is_prune else '', '_prec' if has_prec else ''), newline='') as csvfile:
