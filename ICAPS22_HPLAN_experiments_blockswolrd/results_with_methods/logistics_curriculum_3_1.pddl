( define ( domain logistics )
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_560 ?auto_558 ) ( IN-CITY ?auto_555 ?auto_558 ) ( not ( = ?auto_555 ?auto_560 ) ) ( OBJ-AT ?auto_557 ?auto_560 ) ( IN-CITY ?auto_561 ?auto_558 ) ( not ( = ?auto_555 ?auto_561 ) ) ( OBJ-AT ?auto_556 ?auto_561 ) ( TRUCK-AT ?auto_559 ?auto_555 ) ( not ( = ?auto_556 ?auto_557 ) ) ( not ( = ?auto_560 ?auto_561 ) ) )
    :subtasks
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_568 ?auto_565 ) ( IN-CITY ?auto_562 ?auto_565 ) ( not ( = ?auto_562 ?auto_568 ) ) ( OBJ-AT ?auto_563 ?auto_568 ) ( IN-CITY ?auto_567 ?auto_565 ) ( not ( = ?auto_562 ?auto_567 ) ) ( OBJ-AT ?auto_564 ?auto_567 ) ( TRUCK-AT ?auto_566 ?auto_562 ) ( not ( = ?auto_564 ?auto_563 ) ) ( not ( = ?auto_568 ?auto_567 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_675 ?auto_673 ) ( IN-CITY ?auto_669 ?auto_673 ) ( not ( = ?auto_669 ?auto_675 ) ) ( OBJ-AT ?auto_672 ?auto_675 ) ( OBJ-AT ?auto_671 ?auto_675 ) ( IN-CITY ?auto_676 ?auto_673 ) ( not ( = ?auto_669 ?auto_676 ) ) ( OBJ-AT ?auto_670 ?auto_676 ) ( TRUCK-AT ?auto_674 ?auto_669 ) ( not ( = ?auto_670 ?auto_671 ) ) ( not ( = ?auto_675 ?auto_676 ) ) ( not ( = ?auto_670 ?auto_672 ) ) ( not ( = ?auto_671 ?auto_672 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_690 ?auto_691 ) ( IN-CITY ?auto_686 ?auto_691 ) ( not ( = ?auto_686 ?auto_690 ) ) ( OBJ-AT ?auto_688 ?auto_690 ) ( OBJ-AT ?auto_689 ?auto_690 ) ( IN-CITY ?auto_692 ?auto_691 ) ( not ( = ?auto_686 ?auto_692 ) ) ( OBJ-AT ?auto_687 ?auto_692 ) ( TRUCK-AT ?auto_693 ?auto_686 ) ( not ( = ?auto_687 ?auto_689 ) ) ( not ( = ?auto_690 ?auto_692 ) ) ( not ( = ?auto_687 ?auto_688 ) ) ( not ( = ?auto_689 ?auto_688 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_710 ?auto_708 ) ( IN-CITY ?auto_703 ?auto_708 ) ( not ( = ?auto_703 ?auto_710 ) ) ( OBJ-AT ?auto_706 ?auto_710 ) ( OBJ-AT ?auto_704 ?auto_710 ) ( IN-CITY ?auto_709 ?auto_708 ) ( not ( = ?auto_703 ?auto_709 ) ) ( OBJ-AT ?auto_705 ?auto_709 ) ( TRUCK-AT ?auto_707 ?auto_703 ) ( not ( = ?auto_705 ?auto_704 ) ) ( not ( = ?auto_710 ?auto_709 ) ) ( not ( = ?auto_705 ?auto_706 ) ) ( not ( = ?auto_704 ?auto_706 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_727 ?auto_725 ) ( IN-CITY ?auto_720 ?auto_725 ) ( not ( = ?auto_720 ?auto_727 ) ) ( OBJ-AT ?auto_722 ?auto_727 ) ( OBJ-AT ?auto_721 ?auto_727 ) ( IN-CITY ?auto_726 ?auto_725 ) ( not ( = ?auto_720 ?auto_726 ) ) ( OBJ-AT ?auto_723 ?auto_726 ) ( TRUCK-AT ?auto_724 ?auto_720 ) ( not ( = ?auto_723 ?auto_721 ) ) ( not ( = ?auto_727 ?auto_726 ) ) ( not ( = ?auto_723 ?auto_722 ) ) ( not ( = ?auto_721 ?auto_722 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_762 ?auto_760 ) ( IN-CITY ?auto_755 ?auto_760 ) ( not ( = ?auto_755 ?auto_762 ) ) ( OBJ-AT ?auto_756 ?auto_762 ) ( OBJ-AT ?auto_758 ?auto_762 ) ( IN-CITY ?auto_761 ?auto_760 ) ( not ( = ?auto_755 ?auto_761 ) ) ( OBJ-AT ?auto_757 ?auto_761 ) ( TRUCK-AT ?auto_759 ?auto_755 ) ( not ( = ?auto_757 ?auto_758 ) ) ( not ( = ?auto_762 ?auto_761 ) ) ( not ( = ?auto_757 ?auto_756 ) ) ( not ( = ?auto_758 ?auto_756 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_779 ?auto_777 ) ( IN-CITY ?auto_772 ?auto_777 ) ( not ( = ?auto_772 ?auto_779 ) ) ( OBJ-AT ?auto_773 ?auto_779 ) ( OBJ-AT ?auto_774 ?auto_779 ) ( IN-CITY ?auto_778 ?auto_777 ) ( not ( = ?auto_772 ?auto_778 ) ) ( OBJ-AT ?auto_775 ?auto_778 ) ( TRUCK-AT ?auto_776 ?auto_772 ) ( not ( = ?auto_775 ?auto_774 ) ) ( not ( = ?auto_779 ?auto_778 ) ) ( not ( = ?auto_775 ?auto_773 ) ) ( not ( = ?auto_774 ?auto_773 ) ) )
    :subtasks
