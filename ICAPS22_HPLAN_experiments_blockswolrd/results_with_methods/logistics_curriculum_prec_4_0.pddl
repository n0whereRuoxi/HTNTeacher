( define ( domain logistics )
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1752 ?auto_1751 ) ( IN-CITY ?auto_1747 ?auto_1751 ) ( not ( = ?auto_1747 ?auto_1752 ) ) ( OBJ-AT ?auto_1749 ?auto_1752 ) ( IN-CITY ?auto_1753 ?auto_1751 ) ( not ( = ?auto_1747 ?auto_1753 ) ) ( OBJ-AT ?auto_1748 ?auto_1753 ) ( TRUCK-AT ?auto_1750 ?auto_1747 ) ( not ( = ?auto_1748 ?auto_1749 ) ) ( not ( = ?auto_1752 ?auto_1753 ) ) )
    :subtasks
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1759 ?auto_1760 ) ( IN-CITY ?auto_1754 ?auto_1760 ) ( not ( = ?auto_1754 ?auto_1759 ) ) ( OBJ-AT ?auto_1755 ?auto_1759 ) ( IN-CITY ?auto_1758 ?auto_1760 ) ( not ( = ?auto_1754 ?auto_1758 ) ) ( OBJ-AT ?auto_1756 ?auto_1758 ) ( TRUCK-AT ?auto_1757 ?auto_1754 ) ( not ( = ?auto_1756 ?auto_1755 ) ) ( not ( = ?auto_1759 ?auto_1758 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1867 ?auto_1866 ) ( IN-CITY ?auto_1861 ?auto_1866 ) ( not ( = ?auto_1861 ?auto_1867 ) ) ( OBJ-AT ?auto_1864 ?auto_1867 ) ( IN-CITY ?auto_1868 ?auto_1866 ) ( not ( = ?auto_1861 ?auto_1868 ) ) ( OBJ-AT ?auto_1863 ?auto_1868 ) ( OBJ-AT ?auto_1862 ?auto_1867 ) ( TRUCK-AT ?auto_1865 ?auto_1861 ) ( not ( = ?auto_1862 ?auto_1863 ) ) ( not ( = ?auto_1868 ?auto_1867 ) ) ( not ( = ?auto_1862 ?auto_1864 ) ) ( not ( = ?auto_1863 ?auto_1864 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1901 ?auto_1899 ) ( IN-CITY ?auto_1895 ?auto_1899 ) ( not ( = ?auto_1895 ?auto_1901 ) ) ( OBJ-AT ?auto_1898 ?auto_1901 ) ( IN-CITY ?auto_1900 ?auto_1899 ) ( not ( = ?auto_1895 ?auto_1900 ) ) ( OBJ-AT ?auto_1896 ?auto_1900 ) ( OBJ-AT ?auto_1897 ?auto_1901 ) ( TRUCK-AT ?auto_1902 ?auto_1895 ) ( not ( = ?auto_1897 ?auto_1896 ) ) ( not ( = ?auto_1900 ?auto_1901 ) ) ( not ( = ?auto_1897 ?auto_1898 ) ) ( not ( = ?auto_1896 ?auto_1898 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1918 ?auto_1916 ) ( IN-CITY ?auto_1912 ?auto_1916 ) ( not ( = ?auto_1912 ?auto_1918 ) ) ( OBJ-AT ?auto_1914 ?auto_1918 ) ( IN-CITY ?auto_1917 ?auto_1916 ) ( not ( = ?auto_1912 ?auto_1917 ) ) ( OBJ-AT ?auto_1913 ?auto_1917 ) ( OBJ-AT ?auto_1915 ?auto_1918 ) ( TRUCK-AT ?auto_1919 ?auto_1912 ) ( not ( = ?auto_1915 ?auto_1913 ) ) ( not ( = ?auto_1917 ?auto_1918 ) ) ( not ( = ?auto_1915 ?auto_1914 ) ) ( not ( = ?auto_1913 ?auto_1914 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1953 ?auto_1951 ) ( IN-CITY ?auto_1947 ?auto_1951 ) ( not ( = ?auto_1947 ?auto_1953 ) ) ( OBJ-AT ?auto_1948 ?auto_1953 ) ( IN-CITY ?auto_1952 ?auto_1951 ) ( not ( = ?auto_1947 ?auto_1952 ) ) ( OBJ-AT ?auto_1950 ?auto_1952 ) ( OBJ-AT ?auto_1949 ?auto_1953 ) ( TRUCK-AT ?auto_1954 ?auto_1947 ) ( not ( = ?auto_1949 ?auto_1950 ) ) ( not ( = ?auto_1952 ?auto_1953 ) ) ( not ( = ?auto_1949 ?auto_1948 ) ) ( not ( = ?auto_1950 ?auto_1948 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1970 ?auto_1968 ) ( IN-CITY ?auto_1964 ?auto_1968 ) ( not ( = ?auto_1964 ?auto_1970 ) ) ( OBJ-AT ?auto_1965 ?auto_1970 ) ( IN-CITY ?auto_1969 ?auto_1968 ) ( not ( = ?auto_1964 ?auto_1969 ) ) ( OBJ-AT ?auto_1966 ?auto_1969 ) ( OBJ-AT ?auto_1967 ?auto_1970 ) ( TRUCK-AT ?auto_1971 ?auto_1964 ) ( not ( = ?auto_1967 ?auto_1966 ) ) ( not ( = ?auto_1969 ?auto_1970 ) ) ( not ( = ?auto_1967 ?auto_1965 ) ) ( not ( = ?auto_1966 ?auto_1965 ) ) )
    :subtasks
