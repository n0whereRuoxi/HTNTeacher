( define ( domain logistics )
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1165 ?auto_1166 ) ( IN-CITY ?auto_1162 ?auto_1166 ) ( not ( = ?auto_1162 ?auto_1165 ) ) ( OBJ-AT ?auto_1164 ?auto_1165 ) ( OBJ-AT ?auto_1163 ?auto_1165 ) ( TRUCK-AT ?auto_1167 ?auto_1162 ) ( not ( = ?auto_1163 ?auto_1164 ) ) )
    :subtasks
  ...
  ( :method DELIVER-2PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1173 ?auto_1172 ) ( IN-CITY ?auto_1168 ?auto_1172 ) ( not ( = ?auto_1168 ?auto_1173 ) ) ( OBJ-AT ?auto_1169 ?auto_1173 ) ( OBJ-AT ?auto_1170 ?auto_1173 ) ( TRUCK-AT ?auto_1171 ?auto_1168 ) ( not ( = ?auto_1170 ?auto_1169 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1291 ?auto_1292 ) ( IN-CITY ?auto_1287 ?auto_1292 ) ( not ( = ?auto_1287 ?auto_1291 ) ) ( OBJ-AT ?auto_1289 ?auto_1291 ) ( OBJ-AT ?auto_1290 ?auto_1291 ) ( OBJ-AT ?auto_1288 ?auto_1291 ) ( TRUCK-AT ?auto_1293 ?auto_1287 ) ( not ( = ?auto_1288 ?auto_1290 ) ) ( not ( = ?auto_1288 ?auto_1289 ) ) ( not ( = ?auto_1290 ?auto_1289 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1306 ?auto_1307 ) ( IN-CITY ?auto_1302 ?auto_1307 ) ( not ( = ?auto_1302 ?auto_1306 ) ) ( OBJ-AT ?auto_1305 ?auto_1306 ) ( OBJ-AT ?auto_1303 ?auto_1306 ) ( OBJ-AT ?auto_1304 ?auto_1306 ) ( TRUCK-AT ?auto_1308 ?auto_1302 ) ( not ( = ?auto_1304 ?auto_1303 ) ) ( not ( = ?auto_1304 ?auto_1305 ) ) ( not ( = ?auto_1303 ?auto_1305 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1321 ?auto_1322 ) ( IN-CITY ?auto_1317 ?auto_1322 ) ( not ( = ?auto_1317 ?auto_1321 ) ) ( OBJ-AT ?auto_1319 ?auto_1321 ) ( OBJ-AT ?auto_1318 ?auto_1321 ) ( OBJ-AT ?auto_1320 ?auto_1321 ) ( TRUCK-AT ?auto_1323 ?auto_1317 ) ( not ( = ?auto_1320 ?auto_1318 ) ) ( not ( = ?auto_1320 ?auto_1319 ) ) ( not ( = ?auto_1318 ?auto_1319 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1352 ?auto_1353 ) ( IN-CITY ?auto_1348 ?auto_1353 ) ( not ( = ?auto_1348 ?auto_1352 ) ) ( OBJ-AT ?auto_1349 ?auto_1352 ) ( OBJ-AT ?auto_1351 ?auto_1352 ) ( OBJ-AT ?auto_1350 ?auto_1352 ) ( TRUCK-AT ?auto_1354 ?auto_1348 ) ( not ( = ?auto_1350 ?auto_1351 ) ) ( not ( = ?auto_1350 ?auto_1349 ) ) ( not ( = ?auto_1351 ?auto_1349 ) ) )
    :subtasks
  ...
  ( :method DELIVER-3PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1367 ?auto_1368 ) ( IN-CITY ?auto_1363 ?auto_1368 ) ( not ( = ?auto_1363 ?auto_1367 ) ) ( OBJ-AT ?auto_1364 ?auto_1367 ) ( OBJ-AT ?auto_1365 ?auto_1367 ) ( OBJ-AT ?auto_1366 ?auto_1367 ) ( TRUCK-AT ?auto_1369 ?auto_1363 ) ( not ( = ?auto_1366 ?auto_1365 ) ) ( not ( = ?auto_1366 ?auto_1364 ) ) ( not ( = ?auto_1365 ?auto_1364 ) ) )
    :subtasks
