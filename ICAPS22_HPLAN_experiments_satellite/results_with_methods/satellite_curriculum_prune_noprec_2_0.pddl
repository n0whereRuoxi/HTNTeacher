( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_73 ?auto_76 ) ( SUPPORTS ?auto_73 ?auto_71 ) ( not ( = ?auto_72 ?auto_75 ) ) ( CALIBRATION_TARGET ?auto_73 ?auto_75 ) ( not ( = ?auto_75 ?auto_69 ) ) ( ON_BOARD ?auto_74 ?auto_76 ) ( not ( = ?auto_72 ?auto_69 ) ) ( not ( = ?auto_73 ?auto_74 ) ) ( SUPPORTS ?auto_74 ?auto_70 ) ( CALIBRATION_TARGET ?auto_74 ?auto_75 ) ( POWER_AVAIL ?auto_76 ) ( POINTING ?auto_76 ?auto_77 ) ( not ( = ?auto_75 ?auto_77 ) ) ( not ( = ?auto_69 ?auto_77 ) ) ( not ( = ?auto_70 ?auto_71 ) ) ( not ( = ?auto_72 ?auto_77 ) ) )
    :subtasks
