( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_190 ?auto_189 ) ( SUPPORTS ?auto_190 ?auto_187 ) ( not ( = ?auto_188 ?auto_192 ) ) ( CALIBRATION_TARGET ?auto_190 ?auto_192 ) ( not ( = ?auto_192 ?auto_185 ) ) ( ON_BOARD ?auto_191 ?auto_189 ) ( not ( = ?auto_188 ?auto_185 ) ) ( not ( = ?auto_190 ?auto_191 ) ) ( SUPPORTS ?auto_191 ?auto_186 ) ( CALIBRATION_TARGET ?auto_191 ?auto_192 ) ( POWER_AVAIL ?auto_189 ) ( POINTING ?auto_189 ?auto_193 ) ( not ( = ?auto_192 ?auto_193 ) ) ( not ( = ?auto_185 ?auto_193 ) ) ( not ( = ?auto_186 ?auto_187 ) ) ( not ( = ?auto_188 ?auto_193 ) ) )
    :subtasks
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_199 ?auto_200 ) ( SUPPORTS ?auto_199 ?auto_195 ) ( not ( = ?auto_194 ?auto_198 ) ) ( CALIBRATION_TARGET ?auto_199 ?auto_198 ) ( not ( = ?auto_198 ?auto_197 ) ) ( ON_BOARD ?auto_201 ?auto_200 ) ( not ( = ?auto_194 ?auto_197 ) ) ( not ( = ?auto_199 ?auto_201 ) ) ( SUPPORTS ?auto_201 ?auto_196 ) ( CALIBRATION_TARGET ?auto_201 ?auto_198 ) ( POWER_AVAIL ?auto_200 ) ( POINTING ?auto_200 ?auto_202 ) ( not ( = ?auto_198 ?auto_202 ) ) ( not ( = ?auto_197 ?auto_202 ) ) ( not ( = ?auto_196 ?auto_195 ) ) ( not ( = ?auto_194 ?auto_202 ) ) )
    :subtasks
