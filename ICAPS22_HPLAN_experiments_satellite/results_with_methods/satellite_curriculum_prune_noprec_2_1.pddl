( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_128 ?auto_129 ) ( SUPPORTS ?auto_128 ?auto_124 ) ( not ( = ?auto_125 ?auto_126 ) ) ( CALIBRATION_TARGET ?auto_128 ?auto_126 ) ( not ( = ?auto_126 ?auto_122 ) ) ( ON_BOARD ?auto_127 ?auto_129 ) ( not ( = ?auto_125 ?auto_122 ) ) ( not ( = ?auto_128 ?auto_127 ) ) ( SUPPORTS ?auto_127 ?auto_123 ) ( CALIBRATION_TARGET ?auto_127 ?auto_126 ) ( POWER_AVAIL ?auto_129 ) ( POINTING ?auto_129 ?auto_130 ) ( not ( = ?auto_126 ?auto_130 ) ) ( not ( = ?auto_122 ?auto_130 ) ) ( not ( = ?auto_123 ?auto_124 ) ) ( not ( = ?auto_125 ?auto_130 ) ) )
    :subtasks
