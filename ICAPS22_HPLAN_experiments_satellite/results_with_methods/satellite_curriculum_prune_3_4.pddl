( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( not ( = ?auto_1945 ?auto_1942 ) ) ( ON_BOARD ?auto_1946 ?auto_1949 ) ( SUPPORTS ?auto_1946 ?auto_1944 ) ( not ( = ?auto_1945 ?auto_1947 ) ) ( CALIBRATION_TARGET ?auto_1946 ?auto_1947 ) ( not ( = ?auto_1947 ?auto_1942 ) ) ( ON_BOARD ?auto_1948 ?auto_1949 ) ( not ( = ?auto_1946 ?auto_1948 ) ) ( SUPPORTS ?auto_1948 ?auto_1943 ) ( CALIBRATION_TARGET ?auto_1948 ?auto_1947 ) ( POWER_AVAIL ?auto_1949 ) ( POINTING ?auto_1949 ?auto_1950 ) ( not ( = ?auto_1947 ?auto_1950 ) ) ( not ( = ?auto_1942 ?auto_1950 ) ) ( not ( = ?auto_1943 ?auto_1944 ) ) ( not ( = ?auto_1945 ?auto_1950 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    :precondition
    ( and ( not ( = ?auto_2106 ?auto_2103 ) ) ( not ( = ?auto_2107 ?auto_2103 ) ) ( not ( = ?auto_2107 ?auto_2106 ) ) ( ON_BOARD ?auto_2112 ?auto_2109 ) ( SUPPORTS ?auto_2112 ?auto_2108 ) ( not ( = ?auto_2107 ?auto_2110 ) ) ( CALIBRATION_TARGET ?auto_2112 ?auto_2110 ) ( not ( = ?auto_2110 ?auto_2106 ) ) ( ON_BOARD ?auto_2111 ?auto_2109 ) ( not ( = ?auto_2112 ?auto_2111 ) ) ( SUPPORTS ?auto_2111 ?auto_2105 ) ( CALIBRATION_TARGET ?auto_2111 ?auto_2110 ) ( not ( = ?auto_2110 ?auto_2103 ) ) ( ON_BOARD ?auto_2114 ?auto_2109 ) ( not ( = ?auto_2111 ?auto_2114 ) ) ( SUPPORTS ?auto_2114 ?auto_2104 ) ( CALIBRATION_TARGET ?auto_2114 ?auto_2110 ) ( POWER_AVAIL ?auto_2109 ) ( POINTING ?auto_2109 ?auto_2113 ) ( not ( = ?auto_2110 ?auto_2113 ) ) ( not ( = ?auto_2103 ?auto_2113 ) ) ( not ( = ?auto_2104 ?auto_2105 ) ) ( not ( = ?auto_2106 ?auto_2113 ) ) ( not ( = ?auto_2104 ?auto_2108 ) ) ( not ( = ?auto_2105 ?auto_2108 ) ) ( not ( = ?auto_2107 ?auto_2113 ) ) ( not ( = ?auto_2112 ?auto_2114 ) ) )
    :subtasks
