( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :vars
    (
      ?auto_1143 - INSTRUMENT
      ?auto_1142 - SATELLITE
      ?auto_1145 - DIRECTION
      ?auto_1144 - INSTRUMENT
      ?auto_1146 - DIRECTION
    )
    :precondition
    ( and ( not ( = ?auto_1141 ?auto_1138 ) ) ( ON_BOARD ?auto_1143 ?auto_1142 ) ( SUPPORTS ?auto_1143 ?auto_1140 ) ( not ( = ?auto_1141 ?auto_1145 ) ) ( CALIBRATION_TARGET ?auto_1143 ?auto_1145 ) ( not ( = ?auto_1145 ?auto_1138 ) ) ( ON_BOARD ?auto_1144 ?auto_1142 ) ( not ( = ?auto_1143 ?auto_1144 ) ) ( SUPPORTS ?auto_1144 ?auto_1139 ) ( CALIBRATION_TARGET ?auto_1144 ?auto_1145 ) ( POWER_AVAIL ?auto_1142 ) ( POINTING ?auto_1142 ?auto_1146 ) ( not ( = ?auto_1145 ?auto_1146 ) ) ( not ( = ?auto_1138 ?auto_1146 ) ) ( not ( = ?auto_1139 ?auto_1140 ) ) ( not ( = ?auto_1141 ?auto_1146 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    :vars
    (
      ?auto_1307 - INSTRUMENT
      ?auto_1305 - SATELLITE
      ?auto_1306 - DIRECTION
      ?auto_1308 - INSTRUMENT
      ?auto_1309 - INSTRUMENT
      ?auto_1310 - DIRECTION
    )
    :precondition
    ( and ( not ( = ?auto_1302 ?auto_1299 ) ) ( not ( = ?auto_1303 ?auto_1299 ) ) ( not ( = ?auto_1303 ?auto_1302 ) ) ( ON_BOARD ?auto_1307 ?auto_1305 ) ( SUPPORTS ?auto_1307 ?auto_1304 ) ( not ( = ?auto_1303 ?auto_1306 ) ) ( CALIBRATION_TARGET ?auto_1307 ?auto_1306 ) ( not ( = ?auto_1306 ?auto_1302 ) ) ( ON_BOARD ?auto_1308 ?auto_1305 ) ( not ( = ?auto_1307 ?auto_1308 ) ) ( SUPPORTS ?auto_1308 ?auto_1301 ) ( CALIBRATION_TARGET ?auto_1308 ?auto_1306 ) ( not ( = ?auto_1306 ?auto_1299 ) ) ( ON_BOARD ?auto_1309 ?auto_1305 ) ( not ( = ?auto_1308 ?auto_1309 ) ) ( SUPPORTS ?auto_1309 ?auto_1300 ) ( CALIBRATION_TARGET ?auto_1309 ?auto_1306 ) ( POWER_AVAIL ?auto_1305 ) ( POINTING ?auto_1305 ?auto_1310 ) ( not ( = ?auto_1306 ?auto_1310 ) ) ( not ( = ?auto_1299 ?auto_1310 ) ) ( not ( = ?auto_1300 ?auto_1301 ) ) ( not ( = ?auto_1302 ?auto_1310 ) ) ( not ( = ?auto_1300 ?auto_1304 ) ) ( not ( = ?auto_1301 ?auto_1304 ) ) ( not ( = ?auto_1303 ?auto_1310 ) ) ( not ( = ?auto_1307 ?auto_1309 ) ) )
    :subtasks
