( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_234 ?auto_232 ) ( SUPPORTS ?auto_234 ?auto_230 ) ( not ( = ?auto_231 ?auto_235 ) ) ( CALIBRATION_TARGET ?auto_234 ?auto_235 ) ( not ( = ?auto_235 ?auto_228 ) ) ( ON_BOARD ?auto_233 ?auto_232 ) ( not ( = ?auto_231 ?auto_228 ) ) ( not ( = ?auto_234 ?auto_233 ) ) ( SUPPORTS ?auto_233 ?auto_229 ) ( CALIBRATION_TARGET ?auto_233 ?auto_235 ) ( POWER_AVAIL ?auto_232 ) ( POINTING ?auto_232 ?auto_236 ) ( not ( = ?auto_235 ?auto_236 ) ) ( not ( = ?auto_228 ?auto_236 ) ) ( not ( = ?auto_229 ?auto_230 ) ) ( not ( = ?auto_231 ?auto_236 ) ) )
    :subtasks
