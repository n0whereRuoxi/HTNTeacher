( define ( domain satellite )
  ...
  ( :method GET-1IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_95 ?auto_94 ) ( SUPPORTS ?auto_95 ?auto_93 ) ( POWER_ON ?auto_95 ) ( POINTING ?auto_94 ?auto_96 ) ( not ( = ?auto_92 ?auto_96 ) ) ( CALIBRATION_TARGET ?auto_95 ?auto_96 ) ( NOT_CALIBRATED ?auto_95 ) )
    :subtasks
    ( ( !CALIBRATE ?auto_94 ?auto_95 ?auto_96 )
  ...
  ( :method GET-1IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_99 ?auto_101 ) ( SUPPORTS ?auto_99 ?auto_98 ) ( POINTING ?auto_101 ?auto_100 ) ( not ( = ?auto_97 ?auto_100 ) ) ( CALIBRATION_TARGET ?auto_99 ?auto_100 ) ( POWER_AVAIL ?auto_101 ) )
    :subtasks
    ( ( !SWITCH_ON ?auto_99 ?auto_101 )
