( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_338 ?auto_341 ) ( SUPPORTS ?auto_338 ?auto_336 ) ( not ( = ?auto_337 ?auto_340 ) ) ( CALIBRATION_TARGET ?auto_338 ?auto_340 ) ( not ( = ?auto_340 ?auto_334 ) ) ( ON_BOARD ?auto_339 ?auto_341 ) ( not ( = ?auto_337 ?auto_334 ) ) ( not ( = ?auto_338 ?auto_339 ) ) ( SUPPORTS ?auto_339 ?auto_335 ) ( CALIBRATION_TARGET ?auto_339 ?auto_340 ) ( POWER_AVAIL ?auto_341 ) ( POINTING ?auto_341 ?auto_342 ) ( not ( = ?auto_340 ?auto_342 ) ) ( not ( = ?auto_334 ?auto_342 ) ) ( not ( = ?auto_335 ?auto_336 ) ) ( not ( = ?auto_337 ?auto_342 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_501 ?auto_502 ) ( SUPPORTS ?auto_501 ?auto_500 ) ( not ( = ?auto_499 ?auto_503 ) ) ( CALIBRATION_TARGET ?auto_501 ?auto_503 ) ( not ( = ?auto_503 ?auto_498 ) ) ( ON_BOARD ?auto_504 ?auto_502 ) ( not ( = ?auto_499 ?auto_498 ) ) ( not ( = ?auto_501 ?auto_504 ) ) ( SUPPORTS ?auto_504 ?auto_497 ) ( CALIBRATION_TARGET ?auto_504 ?auto_503 ) ( not ( = ?auto_503 ?auto_495 ) ) ( ON_BOARD ?auto_506 ?auto_502 ) ( not ( = ?auto_498 ?auto_495 ) ) ( not ( = ?auto_504 ?auto_506 ) ) ( SUPPORTS ?auto_506 ?auto_496 ) ( CALIBRATION_TARGET ?auto_506 ?auto_503 ) ( POWER_AVAIL ?auto_502 ) ( POINTING ?auto_502 ?auto_505 ) ( not ( = ?auto_503 ?auto_505 ) ) ( not ( = ?auto_495 ?auto_505 ) ) ( not ( = ?auto_496 ?auto_497 ) ) ( not ( = ?auto_498 ?auto_505 ) ) ( not ( = ?auto_495 ?auto_499 ) ) ( not ( = ?auto_496 ?auto_500 ) ) ( not ( = ?auto_497 ?auto_500 ) ) ( not ( = ?auto_499 ?auto_505 ) ) ( not ( = ?auto_501 ?auto_506 ) ) )
    :subtasks
