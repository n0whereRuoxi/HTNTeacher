( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_308 ?auto_306 ) ( SUPPORTS ?auto_308 ?auto_303 ) ( not ( = ?auto_304 ?auto_307 ) ) ( CALIBRATION_TARGET ?auto_308 ?auto_307 ) ( not ( = ?auto_307 ?auto_301 ) ) ( ON_BOARD ?auto_305 ?auto_306 ) ( not ( = ?auto_304 ?auto_301 ) ) ( not ( = ?auto_308 ?auto_305 ) ) ( SUPPORTS ?auto_305 ?auto_302 ) ( CALIBRATION_TARGET ?auto_305 ?auto_307 ) ( POWER_AVAIL ?auto_306 ) ( POINTING ?auto_306 ?auto_309 ) ( not ( = ?auto_307 ?auto_309 ) ) ( not ( = ?auto_301 ?auto_309 ) ) ( not ( = ?auto_302 ?auto_303 ) ) ( not ( = ?auto_304 ?auto_309 ) ) )
    :subtasks
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_316 ?auto_318 ) ( SUPPORTS ?auto_316 ?auto_311 ) ( not ( = ?auto_310 ?auto_314 ) ) ( CALIBRATION_TARGET ?auto_316 ?auto_314 ) ( not ( = ?auto_314 ?auto_313 ) ) ( ON_BOARD ?auto_315 ?auto_318 ) ( not ( = ?auto_310 ?auto_313 ) ) ( not ( = ?auto_316 ?auto_315 ) ) ( SUPPORTS ?auto_315 ?auto_312 ) ( CALIBRATION_TARGET ?auto_315 ?auto_314 ) ( POWER_AVAIL ?auto_318 ) ( POINTING ?auto_318 ?auto_317 ) ( not ( = ?auto_314 ?auto_317 ) ) ( not ( = ?auto_313 ?auto_317 ) ) ( not ( = ?auto_312 ?auto_311 ) ) ( not ( = ?auto_310 ?auto_317 ) ) )
    :subtasks
