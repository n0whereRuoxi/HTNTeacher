( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( not ( = ?auto_72 ?auto_69 ) ) ( ON_BOARD ?auto_73 ?auto_75 ) ( SUPPORTS ?auto_73 ?auto_71 ) ( not ( = ?auto_72 ?auto_76 ) ) ( CALIBRATION_TARGET ?auto_73 ?auto_76 ) ( not ( = ?auto_76 ?auto_69 ) ) ( ON_BOARD ?auto_74 ?auto_75 ) ( not ( = ?auto_73 ?auto_74 ) ) ( SUPPORTS ?auto_74 ?auto_70 ) ( CALIBRATION_TARGET ?auto_74 ?auto_76 ) ( POWER_AVAIL ?auto_75 ) ( POINTING ?auto_75 ?auto_77 ) ( not ( = ?auto_76 ?auto_77 ) ) ( not ( = ?auto_69 ?auto_77 ) ) ( not ( = ?auto_70 ?auto_71 ) ) ( not ( = ?auto_72 ?auto_77 ) ) )
    :subtasks
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( not ( = ?auto_81 ?auto_78 ) ) ( ON_BOARD ?auto_86 ?auto_82 ) ( SUPPORTS ?auto_86 ?auto_79 ) ( not ( = ?auto_78 ?auto_84 ) ) ( CALIBRATION_TARGET ?auto_86 ?auto_84 ) ( not ( = ?auto_84 ?auto_81 ) ) ( ON_BOARD ?auto_83 ?auto_82 ) ( not ( = ?auto_86 ?auto_83 ) ) ( SUPPORTS ?auto_83 ?auto_80 ) ( CALIBRATION_TARGET ?auto_83 ?auto_84 ) ( POWER_AVAIL ?auto_82 ) ( POINTING ?auto_82 ?auto_85 ) ( not ( = ?auto_84 ?auto_85 ) ) ( not ( = ?auto_81 ?auto_85 ) ) ( not ( = ?auto_80 ?auto_79 ) ) ( not ( = ?auto_78 ?auto_85 ) ) )
    :subtasks
    ( ( GET-2IMAGE ?auto_81 ?auto_80 ?auto_78 ?auto_79 )
      ( GET-2IMAGE-VERIFY ?auto_78 ?auto_79 ?auto_81 ?auto_80 ) )
  )
