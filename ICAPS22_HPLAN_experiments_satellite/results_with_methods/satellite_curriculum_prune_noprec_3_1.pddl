( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_740 ?auto_741 ) ( SUPPORTS ?auto_740 ?auto_738 ) ( not ( = ?auto_739 ?auto_743 ) ) ( CALIBRATION_TARGET ?auto_740 ?auto_743 ) ( not ( = ?auto_743 ?auto_736 ) ) ( ON_BOARD ?auto_742 ?auto_741 ) ( not ( = ?auto_739 ?auto_736 ) ) ( not ( = ?auto_740 ?auto_742 ) ) ( SUPPORTS ?auto_742 ?auto_737 ) ( CALIBRATION_TARGET ?auto_742 ?auto_743 ) ( POWER_AVAIL ?auto_741 ) ( POINTING ?auto_741 ?auto_744 ) ( not ( = ?auto_743 ?auto_744 ) ) ( not ( = ?auto_736 ?auto_744 ) ) ( not ( = ?auto_737 ?auto_738 ) ) ( not ( = ?auto_739 ?auto_744 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_903 ?auto_904 ) ( SUPPORTS ?auto_903 ?auto_902 ) ( not ( = ?auto_901 ?auto_905 ) ) ( CALIBRATION_TARGET ?auto_903 ?auto_905 ) ( not ( = ?auto_905 ?auto_900 ) ) ( ON_BOARD ?auto_906 ?auto_904 ) ( not ( = ?auto_901 ?auto_900 ) ) ( not ( = ?auto_903 ?auto_906 ) ) ( SUPPORTS ?auto_906 ?auto_899 ) ( CALIBRATION_TARGET ?auto_906 ?auto_905 ) ( not ( = ?auto_905 ?auto_897 ) ) ( ON_BOARD ?auto_908 ?auto_904 ) ( not ( = ?auto_900 ?auto_897 ) ) ( not ( = ?auto_906 ?auto_908 ) ) ( SUPPORTS ?auto_908 ?auto_898 ) ( CALIBRATION_TARGET ?auto_908 ?auto_905 ) ( POWER_AVAIL ?auto_904 ) ( POINTING ?auto_904 ?auto_907 ) ( not ( = ?auto_905 ?auto_907 ) ) ( not ( = ?auto_897 ?auto_907 ) ) ( not ( = ?auto_898 ?auto_899 ) ) ( not ( = ?auto_900 ?auto_907 ) ) ( not ( = ?auto_897 ?auto_901 ) ) ( not ( = ?auto_898 ?auto_902 ) ) ( not ( = ?auto_899 ?auto_902 ) ) ( not ( = ?auto_901 ?auto_907 ) ) ( not ( = ?auto_903 ?auto_908 ) ) )
    :subtasks
