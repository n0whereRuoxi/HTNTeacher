( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( not ( = ?auto_1543 ?auto_1540 ) ) ( ON_BOARD ?auto_1545 ?auto_1544 ) ( SUPPORTS ?auto_1545 ?auto_1542 ) ( not ( = ?auto_1543 ?auto_1546 ) ) ( CALIBRATION_TARGET ?auto_1545 ?auto_1546 ) ( not ( = ?auto_1546 ?auto_1540 ) ) ( ON_BOARD ?auto_1547 ?auto_1544 ) ( not ( = ?auto_1545 ?auto_1547 ) ) ( SUPPORTS ?auto_1547 ?auto_1541 ) ( CALIBRATION_TARGET ?auto_1547 ?auto_1546 ) ( POWER_AVAIL ?auto_1544 ) ( POINTING ?auto_1544 ?auto_1548 ) ( not ( = ?auto_1546 ?auto_1548 ) ) ( not ( = ?auto_1540 ?auto_1548 ) ) ( not ( = ?auto_1541 ?auto_1542 ) ) ( not ( = ?auto_1543 ?auto_1548 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    (
      ...
      ?auto_1711 - INSTRUMENT
      ?auto_1712 - DIRECTION
    )
    :precondition
    ( and ( not ( = ?auto_1704 ?auto_1701 ) ) ( not ( = ?auto_1705 ?auto_1701 ) ) ( not ( = ?auto_1705 ?auto_1704 ) ) ( ON_BOARD ?auto_1708 ?auto_1707 ) ( SUPPORTS ?auto_1708 ?auto_1706 ) ( not ( = ?auto_1705 ?auto_1710 ) ) ( CALIBRATION_TARGET ?auto_1708 ?auto_1710 ) ( not ( = ?auto_1710 ?auto_1704 ) ) ( ON_BOARD ?auto_1709 ?auto_1707 ) ( not ( = ?auto_1708 ?auto_1709 ) ) ( SUPPORTS ?auto_1709 ?auto_1703 ) ( CALIBRATION_TARGET ?auto_1709 ?auto_1710 ) ( not ( = ?auto_1710 ?auto_1701 ) ) ( ON_BOARD ?auto_1711 ?auto_1707 ) ( not ( = ?auto_1709 ?auto_1711 ) ) ( SUPPORTS ?auto_1711 ?auto_1702 ) ( CALIBRATION_TARGET ?auto_1711 ?auto_1710 ) ( POWER_AVAIL ?auto_1707 ) ( POINTING ?auto_1707 ?auto_1712 ) ( not ( = ?auto_1710 ?auto_1712 ) ) ( not ( = ?auto_1701 ?auto_1712 ) ) ( not ( = ?auto_1702 ?auto_1703 ) ) ( not ( = ?auto_1704 ?auto_1712 ) ) ( not ( = ?auto_1702 ?auto_1706 ) ) ( not ( = ?auto_1703 ?auto_1706 ) ) ( not ( = ?auto_1705 ?auto_1712 ) ) ( not ( = ?auto_1708 ?auto_1711 ) ) )
    :subtasks
