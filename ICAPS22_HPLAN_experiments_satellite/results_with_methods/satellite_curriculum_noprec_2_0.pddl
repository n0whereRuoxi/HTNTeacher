( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_74 ?auto_73 ) ( SUPPORTS ?auto_74 ?auto_71 ) ( not ( = ?auto_72 ?auto_76 ) ) ( CALIBRATION_TARGET ?auto_74 ?auto_76 ) ( not ( = ?auto_76 ?auto_69 ) ) ( ON_BOARD ?auto_75 ?auto_73 ) ( not ( = ?auto_72 ?auto_69 ) ) ( not ( = ?auto_74 ?auto_75 ) ) ( SUPPORTS ?auto_75 ?auto_70 ) ( CALIBRATION_TARGET ?auto_75 ?auto_76 ) ( POWER_AVAIL ?auto_73 ) ( POINTING ?auto_73 ?auto_77 ) ( not ( = ?auto_76 ?auto_77 ) ) ( not ( = ?auto_69 ?auto_77 ) ) ( not ( = ?auto_70 ?auto_71 ) ) ( not ( = ?auto_72 ?auto_77 ) ) )
    :subtasks
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_83 ?auto_86 ) ( SUPPORTS ?auto_83 ?auto_79 ) ( not ( = ?auto_78 ?auto_84 ) ) ( CALIBRATION_TARGET ?auto_83 ?auto_84 ) ( not ( = ?auto_84 ?auto_81 ) ) ( ON_BOARD ?auto_82 ?auto_86 ) ( not ( = ?auto_78 ?auto_81 ) ) ( not ( = ?auto_83 ?auto_82 ) ) ( SUPPORTS ?auto_82 ?auto_80 ) ( CALIBRATION_TARGET ?auto_82 ?auto_84 ) ( POWER_AVAIL ?auto_86 ) ( POINTING ?auto_86 ?auto_85 ) ( not ( = ?auto_84 ?auto_85 ) ) ( not ( = ?auto_81 ?auto_85 ) ) ( not ( = ?auto_80 ?auto_79 ) ) ( not ( = ?auto_78 ?auto_85 ) ) )
    :subtasks
