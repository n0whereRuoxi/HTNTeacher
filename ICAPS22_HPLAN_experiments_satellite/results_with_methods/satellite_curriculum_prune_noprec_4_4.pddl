( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_21008 ?auto_21010 ) ( SUPPORTS ?auto_21008 ?auto_21006 ) ( not ( = ?auto_21007 ?auto_21009 ) ) ( CALIBRATION_TARGET ?auto_21008 ?auto_21009 ) ( not ( = ?auto_21009 ?auto_21004 ) ) ( ON_BOARD ?auto_21011 ?auto_21010 ) ( not ( = ?auto_21007 ?auto_21004 ) ) ( not ( = ?auto_21008 ?auto_21011 ) ) ( SUPPORTS ?auto_21011 ?auto_21005 ) ( CALIBRATION_TARGET ?auto_21011 ?auto_21009 ) ( POWER_AVAIL ?auto_21010 ) ( POINTING ?auto_21010 ?auto_21012 ) ( not ( = ?auto_21009 ?auto_21012 ) ) ( not ( = ?auto_21004 ?auto_21012 ) ) ( not ( = ?auto_21005 ?auto_21006 ) ) ( not ( = ?auto_21007 ?auto_21012 ) ) )
    :subtasks
  ...
  ( :method GET-3IMAGE
    ...
    (
      ...
      ?auto_21173 - SATELLITE
      ?auto_21172 - DIRECTION
      ?auto_21171 - INSTRUMENT
      ?auto_21176 - INSTRUMENT
      ?auto_21175 - DIRECTION
    )
    :precondition
    ( and ( ON_BOARD ?auto_21174 ?auto_21173 ) ( SUPPORTS ?auto_21174 ?auto_21170 ) ( not ( = ?auto_21169 ?auto_21172 ) ) ( CALIBRATION_TARGET ?auto_21174 ?auto_21172 ) ( not ( = ?auto_21172 ?auto_21168 ) ) ( ON_BOARD ?auto_21171 ?auto_21173 ) ( not ( = ?auto_21169 ?auto_21168 ) ) ( not ( = ?auto_21174 ?auto_21171 ) ) ( SUPPORTS ?auto_21171 ?auto_21167 ) ( CALIBRATION_TARGET ?auto_21171 ?auto_21172 ) ( not ( = ?auto_21172 ?auto_21165 ) ) ( ON_BOARD ?auto_21176 ?auto_21173 ) ( not ( = ?auto_21168 ?auto_21165 ) ) ( not ( = ?auto_21171 ?auto_21176 ) ) ( SUPPORTS ?auto_21176 ?auto_21166 ) ( CALIBRATION_TARGET ?auto_21176 ?auto_21172 ) ( POWER_AVAIL ?auto_21173 ) ( POINTING ?auto_21173 ?auto_21175 ) ( not ( = ?auto_21172 ?auto_21175 ) ) ( not ( = ?auto_21165 ?auto_21175 ) ) ( not ( = ?auto_21166 ?auto_21167 ) ) ( not ( = ?auto_21168 ?auto_21175 ) ) ( not ( = ?auto_21165 ?auto_21169 ) ) ( not ( = ?auto_21166 ?auto_21170 ) ) ( not ( = ?auto_21167 ?auto_21170 ) ) ( not ( = ?auto_21169 ?auto_21175 ) ) ( not ( = ?auto_21174 ?auto_21176 ) ) )
    :subtasks
  ...
  ( :method GET-4IMAGE
    ...
    (
      ...
      ?auto_22955 - INSTRUMENT
      ?auto_22957 - INSTRUMENT
      ?auto_22959 - INSTRUMENT
      ?auto_22958 - DIRECTION
    )
    :precondition
    ( and ( ON_BOARD ?auto_22954 ?auto_22956 ) ( SUPPORTS ?auto_22954 ?auto_22952 ) ( not ( = ?auto_22951 ?auto_22953 ) ) ( CALIBRATION_TARGET ?auto_22954 ?auto_22953 ) ( not ( = ?auto_22953 ?auto_22949 ) ) ( ON_BOARD ?auto_22955 ?auto_22956 ) ( not ( = ?auto_22951 ?auto_22949 ) ) ( not ( = ?auto_22954 ?auto_22955 ) ) ( SUPPORTS ?auto_22955 ?auto_22950 ) ( CALIBRATION_TARGET ?auto_22955 ?auto_22953 ) ( not ( = ?auto_22953 ?auto_22948 ) ) ( ON_BOARD ?auto_22957 ?auto_22956 ) ( not ( = ?auto_22949 ?auto_22948 ) ) ( not ( = ?auto_22955 ?auto_22957 ) ) ( SUPPORTS ?auto_22957 ?auto_22947 ) ( CALIBRATION_TARGET ?auto_22957 ?auto_22953 ) ( not ( = ?auto_22953 ?auto_22945 ) ) ( ON_BOARD ?auto_22959 ?auto_22956 ) ( not ( = ?auto_22948 ?auto_22945 ) ) ( not ( = ?auto_22957 ?auto_22959 ) ) ( SUPPORTS ?auto_22959 ?auto_22946 ) ( CALIBRATION_TARGET ?auto_22959 ?auto_22953 ) ( POWER_AVAIL ?auto_22956 ) ( POINTING ?auto_22956 ?auto_22958 ) ( not ( = ?auto_22953 ?auto_22958 ) ) ( not ( = ?auto_22945 ?auto_22958 ) ) ( not ( = ?auto_22946 ?auto_22947 ) ) ( not ( = ?auto_22948 ?auto_22958 ) ) ( not ( = ?auto_22945 ?auto_22949 ) ) ( not ( = ?auto_22946 ?auto_22950 ) ) ( not ( = ?auto_22947 ?auto_22950 ) ) ( not ( = ?auto_22949 ?auto_22958 ) ) ( not ( = ?auto_22955 ?auto_22959 ) ) ( not ( = ?auto_22945 ?auto_22951 ) ) ( not ( = ?auto_22946 ?auto_22952 ) ) ( not ( = ?auto_22948 ?auto_22951 ) ) ( not ( = ?auto_22947 ?auto_22952 ) ) ( not ( = ?auto_22950 ?auto_22952 ) ) ( not ( = ?auto_22951 ?auto_22958 ) ) ( not ( = ?auto_22954 ?auto_22957 ) ) ( not ( = ?auto_22954 ?auto_22959 ) ) )
    :subtasks
