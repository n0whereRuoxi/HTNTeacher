( define ( domain satellite )
  ...
  ( :method GET-1IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_13 ?auto_14 ) ( SUPPORTS ?auto_13 ?auto_12 ) ( POWER_ON ?auto_13 ) ( POINTING ?auto_14 ?auto_15 ) ( not ( = ?auto_11 ?auto_15 ) ) ( CALIBRATION_TARGET ?auto_13 ?auto_15 ) ( NOT_CALIBRATED ?auto_13 ) )
    :subtasks
    ( ( !CALIBRATE ?auto_14 ?auto_13 ?auto_15 )
  ...
  ( :method GET-1IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_25 ?auto_23 ) ( SUPPORTS ?auto_25 ?auto_22 ) ( not ( = ?auto_21 ?auto_24 ) ) ( CALIBRATION_TARGET ?auto_25 ?auto_24 ) ( POWER_AVAIL ?auto_23 ) ( POINTING ?auto_23 ?auto_26 ) ( not ( = ?auto_24 ?auto_26 ) ) ( not ( = ?auto_21 ?auto_26 ) ) )
    :subtasks
