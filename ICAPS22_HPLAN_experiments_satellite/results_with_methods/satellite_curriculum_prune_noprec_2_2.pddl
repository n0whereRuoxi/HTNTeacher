( define ( domain satellite )
  ...
  ( :method GET-2IMAGE
    ...
    :precondition
    ( and ( ON_BOARD ?auto_179 ?auto_180 ) ( SUPPORTS ?auto_179 ?auto_177 ) ( not ( = ?auto_178 ?auto_182 ) ) ( CALIBRATION_TARGET ?auto_179 ?auto_182 ) ( not ( = ?auto_182 ?auto_175 ) ) ( ON_BOARD ?auto_181 ?auto_180 ) ( not ( = ?auto_178 ?auto_175 ) ) ( not ( = ?auto_179 ?auto_181 ) ) ( SUPPORTS ?auto_181 ?auto_176 ) ( CALIBRATION_TARGET ?auto_181 ?auto_182 ) ( POWER_AVAIL ?auto_180 ) ( POINTING ?auto_180 ?auto_183 ) ( not ( = ?auto_182 ?auto_183 ) ) ( not ( = ?auto_175 ?auto_183 ) ) ( not ( = ?auto_176 ?auto_177 ) ) ( not ( = ?auto_178 ?auto_183 ) ) )
    :subtasks
