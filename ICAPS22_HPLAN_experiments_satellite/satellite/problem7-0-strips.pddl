( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir307 mode438 )
      ( have_image dir643 mode190 )
      ( have_image dir996 mode297 )
      ( have_image dir192 mode383 )
      ( have_image dir428 mode991 )
      ( have_image dir546 mode347 )
      ( have_image dir746 mode573 )
    )
  )
)
