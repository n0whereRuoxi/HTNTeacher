( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir899 mode884 )
      ( have_image dir430 mode314 )
      ( have_image dir482 mode113 )
      ( have_image dir258 mode356 )
      ( have_image dir661 mode661 )
      ( have_image dir549 mode185 )
    )
  )
)
