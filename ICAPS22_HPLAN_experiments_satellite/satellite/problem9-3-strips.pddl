( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir531 mode392 )
      ( have_image dir944 mode830 )
      ( have_image dir887 mode527 )
      ( have_image dir986 mode926 )
      ( have_image dir571 mode89 )
      ( have_image dir651 mode187 )
      ( have_image dir311 mode379 )
      ( have_image dir911 mode850 )
      ( have_image dir833 mode281 )
    )
  )
)
