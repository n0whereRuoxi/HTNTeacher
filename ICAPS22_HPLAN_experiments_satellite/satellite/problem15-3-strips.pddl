( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir916 mode258 )
      ( have_image dir213 mode256 )
      ( have_image dir978 mode428 )
      ( have_image dir624 mode360 )
      ( have_image dir532 mode739 )
      ( have_image dir958 mode453 )
      ( have_image dir761 mode687 )
      ( have_image dir377 mode933 )
      ( have_image dir33 mode838 )
      ( have_image dir849 mode48 )
      ( have_image dir485 mode869 )
      ( have_image dir236 mode827 )
      ( have_image dir628 mode378 )
      ( have_image dir778 mode817 )
      ( have_image dir434 mode613 )
    )
  )
)
