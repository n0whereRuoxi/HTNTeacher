( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir141 mode797 )
      ( have_image dir159 mode14 )
      ( have_image dir219 mode996 )
      ( have_image dir190 mode784 )
      ( have_image dir997 mode590 )
      ( have_image dir633 mode910 )
      ( have_image dir576 mode658 )
      ( have_image dir862 mode115 )
      ( have_image dir408 mode843 )
      ( have_image dir642 mode276 )
      ( have_image dir69 mode851 )
      ( have_image dir483 mode894 )
      ( have_image dir925 mode919 )
      ( have_image dir708 mode441 )
    )
  )
)
