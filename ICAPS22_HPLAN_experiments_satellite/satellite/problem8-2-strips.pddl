( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir203 mode128 )
      ( have_image dir43 mode577 )
      ( have_image dir874 mode750 )
      ( have_image dir55 mode77 )
      ( have_image dir333 mode760 )
      ( have_image dir204 mode428 )
      ( have_image dir731 mode109 )
      ( have_image dir699 mode903 )
    )
  )
)
