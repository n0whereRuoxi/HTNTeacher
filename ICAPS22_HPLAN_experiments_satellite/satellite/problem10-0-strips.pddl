( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir425 mode714 )
      ( have_image dir999 mode408 )
      ( have_image dir253 mode838 )
      ( have_image dir517 mode562 )
      ( have_image dir859 mode67 )
      ( have_image dir585 mode212 )
      ( have_image dir439 mode832 )
      ( have_image dir56 mode549 )
      ( have_image dir907 mode622 )
      ( have_image dir941 mode12 )
    )
  )
)
