( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir162 mode894 )
      ( have_image dir280 mode113 )
      ( have_image dir541 mode745 )
      ( have_image dir485 mode830 )
      ( have_image dir504 mode783 )
      ( have_image dir568 mode576 )
      ( have_image dir729 mode338 )
      ( have_image dir212 mode651 )
      ( have_image dir706 mode414 )
      ( have_image dir743 mode518 )
      ( have_image dir444 mode421 )
      ( have_image dir17 mode556 )
      ( have_image dir592 mode907 )
      ( have_image dir235 mode279 )
    )
  )
)
