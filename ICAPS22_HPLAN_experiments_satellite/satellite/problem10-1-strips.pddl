( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir710 mode352 )
      ( have_image dir248 mode829 )
      ( have_image dir272 mode652 )
      ( have_image dir333 mode16 )
      ( have_image dir551 mode268 )
      ( have_image dir346 mode30 )
      ( have_image dir982 mode573 )
      ( have_image dir740 mode975 )
      ( have_image dir155 mode496 )
      ( have_image dir437 mode197 )
    )
  )
)
