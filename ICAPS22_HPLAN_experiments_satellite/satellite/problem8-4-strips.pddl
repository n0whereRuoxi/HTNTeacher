( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir838 mode578 )
      ( have_image dir4 mode30 )
      ( have_image dir748 mode998 )
      ( have_image dir982 mode197 )
      ( have_image dir996 mode301 )
      ( have_image dir734 mode488 )
      ( have_image dir913 mode160 )
      ( have_image dir408 mode757 )
    )
  )
)
