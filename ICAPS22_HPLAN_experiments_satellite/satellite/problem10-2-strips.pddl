( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir980 mode165 )
      ( have_image dir679 mode103 )
      ( have_image dir152 mode557 )
      ( have_image dir567 mode296 )
      ( have_image dir624 mode431 )
      ( have_image dir696 mode171 )
      ( have_image dir272 mode42 )
      ( have_image dir203 mode150 )
      ( have_image dir363 mode539 )
      ( have_image dir895 mode229 )
    )
  )
)
