( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir759 mode314 )
      ( have_image dir808 mode315 )
      ( have_image dir847 mode884 )
      ( have_image dir686 mode64 )
      ( have_image dir532 mode136 )
      ( have_image dir108 mode520 )
      ( have_image dir784 mode730 )
      ( have_image dir412 mode434 )
      ( have_image dir812 mode236 )
      ( have_image dir469 mode381 )
      ( have_image dir605 mode571 )
      ( have_image dir39 mode704 )
      ( have_image dir33 mode459 )
      ( have_image dir712 mode48 )
    )
  )
)
