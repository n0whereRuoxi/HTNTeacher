( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir94 mode572 )
      ( have_image dir622 mode443 )
      ( have_image dir233 mode92 )
      ( have_image dir213 mode661 )
      ( have_image dir957 mode691 )
      ( have_image dir393 mode80 )
      ( have_image dir547 mode71 )
      ( have_image dir525 mode540 )
      ( have_image dir599 mode645 )
      ( have_image dir691 mode60 )
      ( have_image dir101 mode490 )
    )
  )
)
