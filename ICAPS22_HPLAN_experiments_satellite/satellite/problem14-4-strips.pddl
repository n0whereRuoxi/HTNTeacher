( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir513 mode547 )
      ( have_image dir91 mode324 )
      ( have_image dir5 mode497 )
      ( have_image dir406 mode26 )
      ( have_image dir157 mode62 )
      ( have_image dir449 mode946 )
      ( have_image dir419 mode403 )
      ( have_image dir297 mode526 )
      ( have_image dir21 mode631 )
      ( have_image dir549 mode696 )
      ( have_image dir528 mode585 )
      ( have_image dir591 mode854 )
      ( have_image dir781 mode290 )
      ( have_image dir6 mode757 )
    )
  )
)
