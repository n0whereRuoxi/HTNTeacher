( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir159 mode259 )
      ( have_image dir265 mode687 )
      ( have_image dir858 mode55 )
      ( have_image dir136 mode969 )
      ( have_image dir783 mode704 )
      ( have_image dir606 mode914 )
      ( have_image dir18 mode87 )
      ( have_image dir663 mode732 )
      ( have_image dir516 mode484 )
      ( have_image dir93 mode436 )
      ( have_image dir465 mode237 )
      ( have_image dir777 mode809 )
      ( have_image dir139 mode662 )
    )
  )
)
