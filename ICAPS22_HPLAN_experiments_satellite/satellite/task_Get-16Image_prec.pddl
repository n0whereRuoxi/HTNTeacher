( define
  ...
  ( :task Get-16Image_prec
    ...
    ( and
      ...
      ( not ( = ?goal_dir16 ?goal_dir1 ) )
      ( not ( = ?goal_dir16 ?goal_dir2 ) )
      ( not ( = ?goal_dir16 ?goal_dir3 ) )
      ( not ( = ?goal_dir16 ?goal_dir4 ) )
      ( not ( = ?goal_dir16 ?goal_dir5 ) )
      ( not ( = ?goal_dir16 ?goal_dir6 ) )
      ( not ( = ?goal_dir16 ?goal_dir7 ) )
      ( not ( = ?goal_dir16 ?goal_dir8 ) )
      ( not ( = ?goal_dir16 ?goal_dir9 ) )
      ( not ( = ?goal_dir16 ?goal_dir10 ) )
      ( not ( = ?goal_dir16 ?goal_dir11 ) )
      ( not ( = ?goal_dir16 ?goal_dir12 ) )
      ( not ( = ?goal_dir16 ?goal_dir13 ) )
      ( not ( = ?goal_dir16 ?goal_dir14 ) )
      ( not ( = ?goal_dir16 ?goal_dir15 ) )
    )
    :effect
    ( and
      ...
      ( have_image ?goal_dir16 ?goal_mode16 )
    )
  )
)
