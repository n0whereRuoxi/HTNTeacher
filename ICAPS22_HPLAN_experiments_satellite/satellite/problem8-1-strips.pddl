( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir891 mode82 )
      ( have_image dir384 mode349 )
      ( have_image dir907 mode424 )
      ( have_image dir940 mode863 )
      ( have_image dir64 mode480 )
      ( have_image dir108 mode921 )
      ( have_image dir173 mode180 )
      ( have_image dir433 mode111 )
    )
  )
)
