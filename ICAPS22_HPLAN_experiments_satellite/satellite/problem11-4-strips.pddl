( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir119 mode847 )
      ( have_image dir23 mode503 )
      ( have_image dir532 mode681 )
      ( have_image dir258 mode274 )
      ( have_image dir52 mode816 )
      ( have_image dir632 mode721 )
      ( have_image dir409 mode708 )
      ( have_image dir756 mode284 )
      ( have_image dir871 mode628 )
      ( have_image dir629 mode936 )
      ( have_image dir719 mode891 )
    )
  )
)
