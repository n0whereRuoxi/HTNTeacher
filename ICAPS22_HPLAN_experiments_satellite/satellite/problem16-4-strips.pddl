( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir678 mode519 )
      ( have_image dir414 mode494 )
      ( have_image dir811 mode277 )
      ( have_image dir71 mode876 )
      ( have_image dir359 mode253 )
      ( have_image dir826 mode155 )
      ( have_image dir443 mode555 )
      ( have_image dir270 mode749 )
      ( have_image dir326 mode205 )
      ( have_image dir173 mode548 )
      ( have_image dir963 mode434 )
      ( have_image dir525 mode442 )
      ( have_image dir251 mode725 )
      ( have_image dir222 mode697 )
      ( have_image dir936 mode979 )
      ( have_image dir463 mode211 )
    )
  )
)
