( define ( problem probname )
  ...
  ( :goal
    ( and
      ( have_image dir641 mode67 )
      ( have_image dir749 mode309 )
      ( have_image dir252 mode46 )
      ( have_image dir295 mode256 )
      ( have_image dir620 mode162 )
      ( have_image dir95 mode746 )
      ( have_image dir489 mode889 )
      ( have_image dir704 mode312 )
      ( have_image dir539 mode244 )
    )
  )
)
