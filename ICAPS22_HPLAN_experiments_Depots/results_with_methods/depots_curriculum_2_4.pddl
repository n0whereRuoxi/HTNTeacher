( define ( domain depots )
  ...
  ( :method MAKE-ON
    ...
    :precondition
    ( and ( HOIST-AT ?auto_94 ?auto_95 ) ( SURFACE-AT ?auto_93 ?auto_95 ) ( CLEAR ?auto_93 ) ( IS-CRATE ?auto_92 ) ( AVAILABLE ?auto_94 ) ( not ( = ?auto_97 ?auto_95 ) ) ( HOIST-AT ?auto_98 ?auto_97 ) ( AVAILABLE ?auto_98 ) ( SURFACE-AT ?auto_92 ?auto_97 ) ( ON ?auto_92 ?auto_99 ) ( CLEAR ?auto_92 ) ( TRUCK-AT ?auto_96 ?auto_95 ) ( not ( = ?auto_92 ?auto_93 ) ) ( not ( = ?auto_92 ?auto_99 ) ) ( not ( = ?auto_93 ?auto_99 ) ) ( not ( = ?auto_94 ?auto_98 ) ) )
    :subtasks
    ( ( !DRIVE ?auto_96 ?auto_95 ?auto_97 )
      ( !LIFT ?auto_98 ?auto_92 ?auto_99 ?auto_97 )
      ( !LOAD ?auto_98 ?auto_92 ?auto_96 ?auto_97 )
      ( !DRIVE ?auto_96 ?auto_97 ?auto_95 )
      ( !UNLOAD ?auto_94 ?auto_92 ?auto_96 ?auto_95 )
      ( !DROP ?auto_94 ?auto_92 ?auto_93 ?auto_95 )
